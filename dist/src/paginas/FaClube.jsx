...
import listaFas from "../fas.json"

export default function FaClube() {
    const conteudo = "A inscrição custa apenas R$3,33!"
    const conteudo2 = "Entre em contato conosco pelo nosso instagram: @dst_noise e peça já!."
    ...
    <>
      ...
      <div className="">
        <Card
          ...
          link={dm}
        ></Card>
        <h1 style={{textAlign:'center'}}>Nossos fãs que já participaram do nosso fã clube:</h1>
